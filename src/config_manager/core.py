...
"""
core.py
AUTHOR: Config Manager Contributors
DATE: 2024
VERSION: 1.0.0
...
from config_manager.types import ConfigSchema, ConfigError
from config_manager.loaders import TOMLLoader, EnvLoader
from config_manager.validators import TypeValidator, SchemaValidator
